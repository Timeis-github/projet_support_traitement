...
lustre_io_df = lustre_io_df.withColumn(
    "start_ts",
    F.least(*[F.col("POSIX_F_READ_START_TIMESTAMP"), F.col("POSIX_F_WRITE_START_TIMESTAMP")])
).withColumn(
    "end_ts",
    F.greatest(*[F.col("POSIX_F_READ_END_TIMESTAMP"), F.col("POSIX_F_WRITE_END_TIMESTAMP")])
).withColumn(
    "io_time",
